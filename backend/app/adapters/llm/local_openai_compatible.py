        ...
        messages: list[dict[str, Any]] = [
            {
                ...
                "content": (
                    ...
                    "The backend deterministically handles clear 'remember', 'update/change', and 'forget' commands before you see the turn. "
                    "If the persistent context already reflects the user's requested memory change, do not issue a duplicate memory write tool call; simply confirm naturally. "
                    "Use memory_search when the user asks what you remember and the supplied persistent context is insufficient. "
                    "Use memory_remember only when the user explicitly asks to remember/save/learn something and the backend context does not already reflect it. "
                    "Use memory_update or memory_forget only when a mutation remains necessary after checking the supplied persistent context. "
